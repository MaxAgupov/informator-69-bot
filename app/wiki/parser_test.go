...
//func TestParse_21_04(t *testing.T) {
//	//location, _ := time.LoadLocation("Europe/Moscow")
//	//now := time.Date(2019, time.April, 21, 1, 1, 1, 1, location)
//	//fullReport := getWikiReport(&now)
//	//fmt.Print(fullReport)
//
//	fullReport := `21 апреля — 111-й день года (112-й в високосные годы) в григорианском календаре.
//До конца года остаётся 254 дня.
//В XX и XXI веках соответствует 8 апреля юлианского календаря.
//
//
//== Праздники и памятные дни ==
...
//
//=== Национальные ===
// Бразилия — День Тирадентеса. В 1792 г. в Рио-де-Жанейро португальцы четвертовали борца за независимость Бразилии де Тирадентеса.
// Италия — День основания Рима.
// Кения — День посадки деревьев.
// Пакистан — День Икбала (в память о смерти в 1938 г. поэта, президента Мусульманской лиги Мухаммеда Икбала, считающегося духовным отцом Пакистана).
// США, Техас — День Сан-Хасинто.
// Россия — День местного самоуправления
//
//
//=== Религиозные ===
// КатолицизмПамять Конрада Парцхамского, монаха (1894 год);
//Память Анастасия Синаита;
//Память Ансельма Кентерберийского. Православие
